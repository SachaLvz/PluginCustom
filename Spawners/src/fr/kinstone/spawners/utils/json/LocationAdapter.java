...
private static String PITCH = "pitch";
	...
	public String getRaw(Location location) {
		...
		return  SpawnersPlugin.getInstance().getJsonFramework().getGson().toJson(serial);
	}

	public Location fromRaw(String raw) {
		Map<String, Object> keys =  SpawnersPlugin.getInstance().getJsonFramework().getGson().fromJson(raw, seriType);
